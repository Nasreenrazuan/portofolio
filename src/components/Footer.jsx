    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://gitlab.com/mohamadnasreenrazuan"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/nasreenrazuan/"><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://www.youtube.com/@nasreenrazuan2780"><i className="ri-youtube-fill ri-2x"></i></a>
        </div>
